...
class CloseCall extends Component {
  ...
  handleChange = e => {
    ...
    this.setState({selectedParty: e.target.value, filteredKnappsteWinners, filteredKnappsteLosers})
  };

  render () {
    const { filteredKnappsteWinners, filteredKnappsteLosers, selectItems, selectedParty } = this.state;
      ...
      <div>
        <Grid container spacing={ 24 }>
          ...
          { selectedParty !== "" &&
            ...
            { filteredKnappsteWinners && filteredKnappsteWinners.length !== 0 &&
              <div>
                <Typography 
                  type="title"
            ...
            { filteredKnappsteLosers && filteredKnappsteLosers.length !== 0 &&
              <div>
                <Typography 
                  type="title" 
                  style={{marginBottom: 18}} 
