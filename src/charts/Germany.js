    ...
    >
      {({ measureRef }) => (
        <div style={{ visibility: showTooltip, color: "#2c2c2c" }}>
          ...
          <div style={arrow(y - (dimensions.height / 2 + 12), x)} />
        </div>
      )}
    </Measure>
  );
...
class Germany extends Component {
  ...
  render() {
    ...
    const hoveredParty = data[hoveredLand]
      ? abbreviatePartyName[data[hoveredLand].partei]
      : "Keine Partei";
                  ...
                  <Geography
                    ...
                    style={{
                      default: {
                        ...
                        opacity:
                          selectedLand === geography.properties.name
                            ? 0.8
                            : 1.0,
                        stroke: "#FFF",
                        strokeWidth:
